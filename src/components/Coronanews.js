			...
			<Grid container >
				...
				<Grid xs={12} sm={4} item>
					<Container align="center" >
						<Typography variant="h5" style={{ color: "#f8fcfd", padding: "20px" }} align="center"><img width="45px" src="/pandemic.png" alt="World Pandemic" style={{ paddingRight: "5px" }}></img>Search Country.</Typography>
						<form align="center" noValidate autoComplete="off" style={{ paddingBottom: "20px" }}>
							<div style={{ padding: "10px" }}>
								<TextField
									...
									style={{ marginRight: "20px" }} id="standard-basic" label="Country" name="country" onChange={this.handleInputChange} />
								<Button style={{ backgroundColor: darkBlue, color: "#f8fcfd", marginTop: "10px" }} onClick={() => this.searchCases()} variant="contained"><SearchIcon />Search</Button>
							</div>
